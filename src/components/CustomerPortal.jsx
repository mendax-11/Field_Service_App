  ...
  return (
    <div className="cp-wrapper">
      ...
      <main className="cp-main">
        {/* Mock SMS Notification Banner simulation for customer */}
        {order.otpSent && !order.otpVerified && (
          <div className="mock-notification-banner" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--color-primary, #3b82f6)' }}>
              <Clock size={14} />
              <strong style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Mock SMS Received</strong>
            </div>
            <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-light, #f8fafc)', lineHeight: '1.4' }}>
              "Dear {order.customerName || 'Customer'}, your TimberFlow assembly verification code is <strong style={{ color: 'var(--color-warning, #f59e0b)', fontSize: '0.95rem' }}>{order.otp}</strong>. Please share this with your technician."
            </p>
          </div>
        )}
