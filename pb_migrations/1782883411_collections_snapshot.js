...
migrate((app) => {
  ...
  {
    "id": "_pb_users_auth_",
    "listRule": "id = @request.auth.id || role != \"Carpenter\"",
    "viewRule": "id = @request.auth.id || role != \"Carpenter\"",
    "createRule": "",
